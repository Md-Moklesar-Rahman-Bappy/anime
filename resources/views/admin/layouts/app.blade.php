    ...
    <div class="flex h-screen">
        <aside class="w-64 bg-gray-900 border-r border-gray-800 p-4 flex flex-col">
            ...
            <nav class="space-y-2 flex-1">
                ...
                <a href="{{ route('admin.manga.index') }}" class="block px-4 py-2 rounded-lg text-sm {{ request()->routeIs('admin.manga.*') && !request()->routeIs('admin.manga.genres.*') ? 'bg-purple-600 text-white' : 'text-gray-400 hover:bg-gray-800 hover:text-white' }}">Manga</a>
                ...
                <a href="{{ route('admin.manga.genres.index') }}" class="block px-4 py-2 rounded-lg text-sm {{ request()->routeIs('admin.manga.genres.*') ? 'bg-purple-600 text-white' : 'text-gray-400 hover:bg-gray-800 hover:text-white' }}">Manga Genres</a>
